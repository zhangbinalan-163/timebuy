...
public class StatisInterceptor implements Interceptor{
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if(logger.isDebugEnabled()){
            logger.debug("sqlId={},sql={},time(ms)={}",sqlId,getShowSql(configuration,boundSql),time);
        }
        return returnValue;
    }

    private static String getShowSql(Configuration configuration, BoundSql boundSql) {
